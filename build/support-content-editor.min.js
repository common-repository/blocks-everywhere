!function(){var e={184:function(e,t){var r;!function(){"use strict";var n={}.hasOwnProperty;function o(){for(var e=[],t=0;t<arguments.length;t++){var r=arguments[t];if(r){var s=typeof r;if("string"===s||"number"===s)e.push(r);else if(Array.isArray(r)){if(r.length){var c=o.apply(null,r);c&&e.push(c)}}else if("object"===s)if(r.toString===Object.prototype.toString)for(var a in r)n.call(r,a)&&r[a]&&e.push(a);else e.push(r.toString())}}return e.join(" ")}e.exports?(o.default=o,e.exports=o):void 0===(r=function(){return o}.apply(t,[]))||(e.exports=r)}()}},t={};function r(n){var o=t[n];if(void 0!==o)return o.exports;var s=t[n]={exports:{}};return e[n](s,s.exports,r),s.exports}r.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return r.d(t,{a:t}),t},r.d=function(e,t){for(var n in t)r.o(t,n)&&!r.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},r.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},function(){"use strict";var e=window.React,t=window.wp.blocks,n=window.wp.element,o=window.wp.i18n;const s=/^https?:\/\/wordpress\.com\/((?<lang>[a-z]{2})\/)?support\/(?<slug>[^# ]+)/i,c=/^https?:\/\/(?<domain>[-a-zA-Z0-9@:%._+~#=]*)\/((?<lang>[a-z]{2})\/)?(?<prefix>[-a-zA-Z0-9@:%._+~#=\/]*)topic\/(?<slug>\S+)$/i,a=400;var l;function u(e){return s.test(e)?l.SUPPORT_PAGE:c.test(e)?l.FORUM_TOPIC:null}async function i(e,t,r){try{const n=r?`https://public-api.wordpress.com/rest/v1.1/users/${e}`:`https://${t}/wp-json/wp/v2/users/${e}`,o=await fetch(n);if(!o.ok)return null;const s=await o.json();return s.display_name||s.name}catch(e){return}}function p(e){return(new DOMParser).parseFromString(e,"text/html").body.textContent||""}!function(e){e.SUPPORT_PAGE="support_page",e.FORUM_TOPIC="forum_topic"}(l||(l={}));var m=window.wp.blockEditor,d=window.wp.components,f=window.wp.compose,h=window.wp.primitives,b=(0,e.createElement)(h.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,e.createElement)(h.Path,{d:"m19 7-3-3-8.5 8.5-1 4 4-1L19 7Zm-7 11.5H5V20h7v-1.5Z"})),v=r(184),w=r.n(v);function _(e,t){return e===t}function E(e){return"function"==typeof e?function(){return e}:e}const g=t=>{const[r,s]=(0,n.useState)([]),[c,a]=(0,n.useState)(!1),[l]=(u=t.search,f=_,p=(0,e.useState)(E(u)),m=p[1],h=[p[0],(0,e.useCallback)((function(e){return m(E(e))}),[])],b=h[0],v=h[1],w=function(t,r,n){var o=this,s=(0,e.useRef)(null),c=(0,e.useRef)(0),a=(0,e.useRef)(null),l=(0,e.useRef)([]),u=(0,e.useRef)(),i=(0,e.useRef)(),p=(0,e.useRef)(t),m=(0,e.useRef)(!0);(0,e.useEffect)((function(){p.current=t}),[t]);var d=!r&&0!==r&&"undefined"!=typeof window;if("function"!=typeof t)throw new TypeError("Expected a function");r=+r||0;var f=!!(n=n||{}).leading,h=!("trailing"in n)||!!n.trailing,b="maxWait"in n,v=b?Math.max(+n.maxWait||0,r):null;(0,e.useEffect)((function(){return m.current=!0,function(){m.current=!1}}),[]);var w=(0,e.useMemo)((function(){var e=function(e){var t=l.current,r=u.current;return l.current=u.current=null,c.current=e,i.current=p.current.apply(r,t)},t=function(e,t){d&&cancelAnimationFrame(a.current),a.current=d?requestAnimationFrame(e):setTimeout(e,t)},n=function(e){if(!m.current)return!1;var t=e-s.current;return!s.current||t>=r||t<0||b&&e-c.current>=v},w=function(t){return a.current=null,h&&l.current?e(t):(l.current=u.current=null,i.current)},_=function e(){var o=Date.now();if(n(o))return w(o);if(m.current){var a=r-(o-s.current),l=b?Math.min(a,v-(o-c.current)):a;t(e,l)}},E=function(){var p=Date.now(),d=n(p);if(l.current=[].slice.call(arguments),u.current=o,s.current=p,d){if(!a.current&&m.current)return c.current=s.current,t(_,r),f?e(s.current):i.current;if(b)return t(_,r),e(s.current)}return a.current||t(_,r),i.current};return E.cancel=function(){a.current&&(d?cancelAnimationFrame(a.current):clearTimeout(a.current)),c.current=0,l.current=s.current=u.current=a.current=null},E.isPending=function(){return!!a.current},E.flush=function(){return a.current?w(Date.now()):i.current},E}),[f,b,r,v,h,d]);return w}((0,e.useCallback)((function(e){return v(e)}),[v]),1e3,i),g=(0,e.useRef)(u),f(g.current,u)||(w(u),g.current=u),[b,w]);var u,i,p,m,f,h,b,v,w,g;return(0,n.useEffect)((()=>{s([]),a(!0)}),[t.search]),(0,n.useEffect)((()=>{(async function(e){const t=`https://public-api.wordpress.com/wp/v2/sites/en.support.wordpress.com/pages?search=${encodeURIComponent(e)}`,r=await fetch(t);if(!r.ok)return[];const n=(await r.json()).map((e=>({title:e.title.rendered.replace("&nbsp;"," "),url:e.link.replace("en.support.wordpress.com","wordpress.com/support")})));return n.length>k?n.slice(0,k):n})(l).then((e=>{s(e),a(!1)}))}),[l]),c||0!==r.length?(0,e.createElement)("div",{className:"be-support-content-search-results"},(0,e.createElement)("div",{className:"be-support-content-search-results__list"},c&&(0,e.createElement)("div",{className:"be-support-content-search-results__loading"},(0,e.createElement)(d.Spinner,null),(0,e.createElement)("span",null,(0,o.__)("Loading content suggestions...","blocks-everywhere"))),r.map((r=>(0,e.createElement)("div",{className:"be-support-content-search-results__item",onClick:()=>t.setUrl(r.url)},(0,e.createElement)("div",{className:"be-support-content-search-results__title"},r.title),(0,e.createElement)("a",{className:"be-support-content-search-results__link",href:r.url,target:"_blank"},r.url)))))):null},k=5,y=t=>{const[r,s]=(0,n.useState)(null),c=t.url?.startsWith("http://")||t.url?.startsWith("https://"),a=!c&&t.url?.length>3;return(0,n.useEffect)((()=>{s(a?t.url:null)}),[t.url,a]),(0,e.createElement)("div",{className:w()("be-support-content-placeholder",t.className)},(0,e.createElement)(d.Placeholder,{icon:t.icon,label:t.label,instructions:t.instructions,notices:t.notices},(0,e.createElement)("form",{onSubmit:e=>{e.preventDefault(),t.onSubmit()}},(0,e.createElement)("input",{type:"url",value:t.url,className:"components-placeholder__input",placeholder:t.placeholder,onChange:e=>t.updateUrl(e.target.value)}),(0,e.createElement)(d.Button,{isPrimary:!0,type:"submit",disabled:!c,"aria-disabled":!c},(0,o._x)("Embed","button label","blocks-everywhere"))),a&&(0,e.createElement)("div",{className:"be-support-content-placeholder__search-slot"},(0,e.createElement)(g,{search:r,setUrl:e=>{t.updateUrl(e),s(e)}}))))},R=()=>{const t=wpBlocksEverywhere.pluginsUrl+"/build/images/wordpress.e7ce7231.png?m=1";return(0,e.createElement)("div",{className:w()("be-support-content-wordpress-icon")},(0,e.createElement)("img",{alt:"WP",src:t}))},N=t=>t.loaded?(0,e.createElement)(e.Fragment,null,t.children):(0,e.createElement)("span",{className:w()("be-support-content-inline-skeleton",{"is-hidden":t.hidden,"is-large":t.large})}),C=t=>{var r;const s=!!t.attributes.content,c=(0,o.sprintf)(
/* translators: Number of people marked this page useful, eg: "25332 people have found this useful" */
(0,o.__)("%1$d people have found this useful!","blocks-everywhere"),null!==(r=t.attributes.minutesToRead)&&void 0!==r?r:0),a=(0,o.sprintf)("in <a>%s</a>",t.attributes.source),l=t.attributes.minutesToRead||t.attributes.author||t.attributes.created;return(0,e.createElement)("div",{className:"be-support-content"},!!t.attributes.created&&(0,e.createElement)("div",{className:"be-support-content__created"},t.attributes.created),t.clickable&&(0,e.createElement)("a",{className:"be-support-content__opener",href:t.attributes.url}),(0,e.createElement)("div",{className:"be-support-content__header"},(0,e.createElement)(R,null),(0,e.createElement)("div",null,(0,e.createElement)("div",{className:"be-support-content__title"},(0,e.createElement)(N,{loaded:s},t.attributes.title)),(0,e.createElement)("div",{className:"be-support-content__source"},(0,e.createElement)(N,{hidden:!0,loaded:s},(0,n.createInterpolateElement)(a,{a:(0,e.createElement)("a",{className:"be-support-content__link",href:t.attributes.sourceURL})}))),(!s||l)&&(0,e.createElement)("div",{className:"be-support-content__details"},(0,e.createElement)(N,{loaded:s},(()=>{if(!s)return null;const r=t.attributes.minutesToRead?(0,o.sprintf)(
/* translators: Minutes it takes to read embedded support page, eg: "5 min to read" */
(0,o.__)("%1$d min read","blocks-everywhere"),t.attributes.minutesToRead):"",n=(0,e.createElement)("span",{className:"be-support-content__relative-created"},t.attributes.created&&t.showRelativeDate?(c=t.attributes.created,(0,window.moment)(c).fromNow()):"");var c;if(t.attributes.author){const s=(0,o.sprintf)(
